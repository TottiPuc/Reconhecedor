...
HERest -T 1 -X phn.txt -L $DB/ -C $IN/featureInfo.txt -I $INPHONE/phonesInTrainSentences0.txt -t 250.0 150.0 1500.0 -S $IN/trainFeaturesFiles.txt -H $OUTMODEL/hmm1_start/macros -H $OUTMODEL/hmm1_start/hmmdefs -M $OUTMODEL/hmm1_start/ $INPHONE/monophones0.txt >> $INHTK/warnings.txt 
done
