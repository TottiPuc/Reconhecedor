...
HResults -T 1 -f -X stc.txt -L $DB -I $RESULT/wordsInTestSentencesTIMIT.txt $INPHONE/monophones1.txt  $IN/testRecognizedWords2.txt >> $IN/testResultsWords.txt

HResults -T 1 -X stc.txt -L $DB -I $RESULT/wordsInTestSentencesTIMIT.txt $INPHONE/monophones1.txt  $IN/testRecognizedWords2.txt
