...
#****************** extract MFCC from TIMIT training data  ********************#

echo "***  Extracting MFCC from TIMIT training data  ***"
...
HCopy -T 0 -C $OUT/HCopyParametersForTrain.txt -S $OUT/trainWavAndFeaturesFiles.txt
